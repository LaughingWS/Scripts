...
{
    [Script(59189)]
    public class TeleportTo_Datascape : CreatureScript
    {
        const uint WLOC_Datascape = 19279;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Datascape);
            if (entry == null)
                return;

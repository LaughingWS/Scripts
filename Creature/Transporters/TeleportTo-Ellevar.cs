...
{
    [Script(46980)]
    public class TeleportTo_Lightreach_Mission : CreatureScript
    {
        const uint WLOC_Lightreach_Mission = 20541;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Lightreach_Mission);
            if (entry == null)
                return;

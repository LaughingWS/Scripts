...
{
    [Script(67480)]
    public class TeleportTo_Bloodstone_Landing : CreatureScript
    {
        const uint WLOC_Bloodstone_Landing = 43971;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Bloodstone_Landing);
            if (entry == null)
                return;

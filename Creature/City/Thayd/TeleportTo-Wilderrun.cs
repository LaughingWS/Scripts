...
{
    [Script(47459)]
    public class TeleportTo_Fools_Hope : CreatureScript
    {
        const uint WLOC_Fools_Hope = 21659;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Fools_Hope);
            if (entry == null)
                return;

...
{
    [Script(62464)]
    public class TeleportTo_Museum_of_Illium : CreatureScript
    {
        const uint WLOC_Museum_of_Illium = 46311;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Museum_of_Illium);
            if (entry == null)
                return;

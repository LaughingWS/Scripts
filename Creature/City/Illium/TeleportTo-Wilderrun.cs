...
{
    [Script(47505)]
    public class TeleportTo_Fort_Vigilance : CreatureScript
    {
        const uint WLOC_Fort_Vigilance = 21660;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Fort_Vigilance);
            if (entry == null)
                return;

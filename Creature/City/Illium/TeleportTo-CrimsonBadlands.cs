...
{
    [Script(67491)]
    public class TeleportTo_Crimson_Command : CreatureScript
    {
        const uint WLOC_Crimson_Command = 43968;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Crimson_Command);
            if (entry == null)
                return;

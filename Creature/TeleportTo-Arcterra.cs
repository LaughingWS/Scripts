...
{
    [Script(70783)]
    public class TeleportTo_Ivory_Hall : CreatureScript
    {
        const uint WLOC_Ivory_Hall = 50181;
        ...
        public override void OnActivateSuccess(WorldEntity me, WorldEntity activator)
        {
            ...
            WorldLocation2Entry entry = GameTableManager.Instance.WorldLocation2.GetEntry(WLOC_Ivory_Hall);
            if (entry == null)
                return;
